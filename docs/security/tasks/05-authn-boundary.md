...
> 작성: 2026-08-14 (v1) · **v2 정정: 2026-08-21** (v1.1 §14 리뷰 완료·절 삭제, 실측 반영)
> ⚠ **두 세션에 걸친 작업이다.** 날짜는 커밋 시점이 아니라 **그 행위가 있었던 시점**을 적는다 —
> 조사·실측·v1은 **8/14**, v2·처방·검증은 **8/21**이다. 일괄 치환하지 말 것
...
> ⚠ **선례 절만 먼저 손댔다 (2026-08-21).** 정본(`precedents.md`) 신설에 딸린 일이라
